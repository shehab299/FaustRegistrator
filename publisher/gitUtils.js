...
const { isPath, mkPath, clearDirectory } = require('./fileUtils');
const fs = require('fs');
...
module.exports = { run, getRegistryDefaultBranch, gitCmd, updateRegistry, publishPackage, downloadPackage, resetRegistry, switchToNewBranch };
